...
package com.example.project_swetha.detection.tflite;
...
import com.example.project_swetha.Recording;
import com.example.project_swetha.detection.env.Logger;
...
/**
 * Wrapper for frozen com.example.project_swetha.detection models trained using the Tensorflow Object Detection API:
...
public class YoloV4Classifier implements Classifier {
    ...
    public float getObjThresh() {
        return Recording.MINIMUM_CONFIDENCE_TF_OD_API;
    }
    ...
    protected ArrayList<Recognition> nms(ArrayList<Recognition> list) {
        ...
        for (int k = 0; k < labels.size(); k++) {
            ...
            while (pq.size() > 0) {
                //insert com.example.project_swetha.detection with max confidence
