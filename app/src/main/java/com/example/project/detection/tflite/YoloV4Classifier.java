...
package com.example.project.detection.tflite;
...
import com.example.project.Recording;
import com.example.project.detection.env.Logger;
...
/**
 * Wrapper for frozen com.example.project.detection models trained using the Tensorflow Object Detection API:
...
public class YoloV4Classifier implements Classifier {
    ...
    protected ArrayList<Recognition> nms(ArrayList<Recognition> list) {
        ...
        for (int k = 0; k < labels.size(); k++) {
            ...
            while (pq.size() > 0) {
                //insert com.example.project.detection with max confidence
